...
import com.example.fastFood.adapter.AllMenuAdapter;
import com.example.fastFood.adapter.PopularAdapter;
import com.example.fastFood.adapter.RecommendedAdapter;
...
import com.example.fastFood.model.Recommended;
import com.example.fastFood.retrofit.ApiInterface;
import com.example.fastFood.retrofit.RetrofitClient;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        call.enqueue(new Callback<List<FoodData>>() {
            ...
            public void onFailure(Call<List<FoodData>> call, Throwable t) {
                Toast.makeText(MainActivity2.this, "Server is not responding.", Toast.LENGTH_SHORT).show();
            }
        });
